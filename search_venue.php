...
<body>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <select id="inputState" class="form-control">
          <option selected>Any</option>
          <option>Morning (8:00 am to 11:30 am)</option>
          <option>Afternoon (12:00 pm to 4:30 pm)</option>
          <option>Evening (5:00 pm to 7:30 pm)</option>
          <option>Night(8:00 pm to 12:00 am)</option>
          <option>Any</option>
        </select>
      </div>
  </div>
