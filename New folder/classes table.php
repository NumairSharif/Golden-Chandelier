...
<body>
    ...
    <!-- Header End -->
    <!-- Hero Section Begin -->
    <div class="hero-section set-bg" data-setbg="img/classes-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero-text">
    ...
    <div class="classes-section spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-classes-item">
                        <i class="flaticon-040-weight"></i>
                        <h4>Wheight Lifting</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="single-classes-item">
                        <i class="flaticon-019-heart"></i>
                        <h4>Yoga</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
    ...
    <div class="classes-time-section spad set-bg" data-setbg="img/classes-time-bg.jpg">
        <div class="container">
            <div class="row">
    ...
    <!-- Classes Time Section End -->
    <!-- WOD Section Begin -->
    <section class="wod-section spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>WOD- Work of the day</h2>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single-wod-item">
                        <span>February 12, 2019</span>
                        <h4>Atomic Crossfit</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single-wod-item">
                        <span>February 09, 2019</span>
                        <h4>12 Days Challenge</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single-wod-item">
    ...
    <!-- Map Section Begin -->
    <div class="map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d24182.553681405774!2d-73.99529774360377!3d40.744003480221!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259737e225aa1%3A0x652ff78189c0e104!2sStuyvesant%20Town-Peter%20Cooper%20Village%2C%20New%20York%2C%20NY%2C%20USA!5e0!3m2!1sen!2sbd!4v1567961277124!5m2!1sen!2sbd" height="585" style="border:0" allowfullscreen></iframe>
