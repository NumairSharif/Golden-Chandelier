...
<body>
    ...
    <!-- Header End -->
    <!-- Hero Section Begin -->
    <div class="hero-section set-bg" data-setbg="img/events-6.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero-text">
        ...
        <div class="container">
          ...
          <div align="center">
            <div class="row">
              ...
              <a href="venues.php">  <button type="button" class="btn btn-primary btn-lg btn-block">Venue List</button> </a>
              <a href="vendors.php">  <button type="button" class="btn btn-primary btn-lg btn-block">Vendor List</button> </a>
              <a href="inner_vnbook.php">  <button type="button" class="btn btn-primary btn-lg btn-block">Venue Book Form</button> </a>
              <a href="inner_vdbook.php">  <button type="button" class="btn btn-primary btn-lg btn-block">Vendor Book Form</button> </a>
              <a href="username_check.php">  <button type="button" class="btn btn-primary btn-lg btn-block">Venue Booked History</button> </a>
              <a href="username_check1.php">  <button type="button" class="btn btn-primary btn-lg btn-block">Vendor Booked History</button> </a>
              </div>
