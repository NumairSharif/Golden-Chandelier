  ...
  <tbody>
    <?php
       ...
       try{
           ...
           $stmt="SELECT vb.venbook_id, c.customer_id, c.name , v.brand_name ,v.type ,v.location, v.hire_cost, v.email, vb.booking_date ,vb.event_date , vb.event_type, vb.event_loc, vb.vdb_schedule , vb.duration, vb.total_payment , vb.paid_deposit, vb.amount_due

           FROM customers as c, vendors as v, vendors_booking as vb
           WHERE c.customer_id=vb.customer_id AND vb.vendor_id =v.vendor_id and c.cus_username='$userid' and c.cus_password='$pass'  ";
