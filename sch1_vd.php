    ...
    <?php
          ...
          $cost=10000000000000;
           ...
           try{
               ...
               if($vdt!="Any" && $loc!="Any" && $e!=0   && $sch!="Any"){
                   $stmt="SELECT v.brand_name, v.type , v.location, v.experience, v.specialty, v.hire_cost, v.availability,       v.vendor_schedule, v.contact  ,v.email
                           FROM vendors as v
                           where v.type='$vnt' and v.location='$loc' and v.hire_cost <= $cost and v.vendor_schedule like \"%$sch%\" ";

               }
               else if($vdt=="Any" && $loc!="Any" && $e!=0  && $sch!="Any"){
                   $stmt="SELECT v.brand_name, v.type , v.location, v.experience, v.specialty, v.hire_cost, v.availability,       v.vendor_schedule, v.contact  ,v.email
                           FROM vendors as v
                           where v.location='$loc' and v.hire_cost <= $cost and v.vendor_schedule like \"%$sch%\" ";

               }else if( $vdt=="Any" && $loc=="Any" && $e!=0  && $sch!="Any"){
                   $stmt="SELECT v.brand_name, v.type , v.location, v.experience, v.specialty, v.hire_cost, v.availability,       v.vendor_schedule, v.contact  ,v.email
                           FROM vendors as v
                           where v.hire_cost <= $cost and v.vendor_schedule like \"%$sch%\" ";

               }else if( $vdt=="Any" && $loc=="Any" && $e==0  && $sch!="Any"){
                   $stmt="SELECT v.brand_name, v.type , v.location, v.experience, v.specialty, v.hire_cost, v.availability,       v.vendor_schedule, v.contact  ,v.email
                           FROM vendors as v
                           where v.vendor_schedule like \"%$sch%\" ";

               }
              else if( $vdt=="Any" && $loc=="Any" && $e!=0  && $sch=="Any"){
                   $stmt="SELECT v.brand_name, v.type , v.location, v.experience, v.specialty, v.hire_cost, v.availability,       v.vendor_schedule, v.contact  ,v.email
                           FROM vendors as v
                           where v.hire_cost <= $cost ";
