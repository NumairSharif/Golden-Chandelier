        ...
        <div class="container">
          <div align="center">
            <div class="row">
              ...
              <form method="post" action="inner_vdbook1.php">
              ...
              <div class="form-group row">
                ...
                <label for=" vdtype" class="col-sm-2 col-form-label">Vendor Type</label>
              ...
              <div class="form-group row">
                ...
                <label for="bdate" class="col-sm-2 col-form-label">Vendor Name</label>
              ...
              <div class="form-group row">
                ...
                <label for="eloc" class="col-sm-2 col-form-label">Event Location </label>


                <div class="col-sm-6">
                    <input type="password" id="eloc"  name="eloc"   class="form-control" >
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  ...
                  <select id="sch" name="sch" class="form-control">
                        ...
                        <option value="Morning" selected>Morning (8 am to 12 pm)</option>
